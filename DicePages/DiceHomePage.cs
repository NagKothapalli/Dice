...
namespace Dice.DicePages
{
    public class DiceHomePage
    {
        ...
        [FindsBy(How = How.XPath, Using = "//a[contains(@href,'mercuryregister')]")]
        ...
        public void BooleanSearch()
        {
            ...
            for (int i = 1; i < 5; i++)
            {
                string searchString = XLUtility.ReadCellValue("BooleanSearch", i, 0);
                runSearch(searchString);
                CaptureTheSearchResults(i, searchString);
            }
        }
